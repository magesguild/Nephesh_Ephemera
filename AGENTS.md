...
- **5.3.1** — final Python patch: heartbeat and dreaming, the OpenCode SDK
  handoff, Windows/Ubuntu portability, and final release hardening. Native
  Windows evidence is recorded in `docs/PLATFORM_ACCEPTANCE.md`; Ubuntu remains
  best-effort portability. Do not infer native platform behavior from mocked
  branches.
