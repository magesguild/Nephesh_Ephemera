...
**Not yet implemented:** a pause/tripwire condition to detect distress or looping patterns across runs and halt for review, and a decision on the actual scheduling mechanism (intended to be part of the MCP service itself, not a separate cron job, tested at low frequency before scaling up).
