...
MEMORY_TYPES = {
    ...
    "message",
    "insight",
    # Raw heartbeat output (see heartbeat.py v3, "raw thinking") — a
    # private synthesized reflection, not a lived memory. No forced
    # sub-classification; "insight" is kept above only for backward
    # compatibility with rows already stored under that type.
    "thought",
    # Live-session-only types (never generated by the heartbeat): a
    # commitment made between Thalia and a companion, a first/notable
